...
class MicwagLastPostsWidget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'New Title', 'micwag-last-posts-widget' );
		}

		echo '<p><label for="' . $this->get_field_id( 'title' ) . '">' . __( 'Title', 'micwag-last-posts-widget' )
		     . ': </label>';
		...
		if ( isset( $instance['numPosts'] ) ) {
			...
			$num_posts = __( '3', 'micwag-last-posts-widget' );
		}

		echo '<p><label for="' . $this->get_field_id( 'numPosts' ) . '">'
		     . __( 'Number of displayed posts', 'micwag-last-posts-widget' )
		     . ': </label>';
		...
		echo '<p><label for="' . $this->get_field_id( 'widgetContent' ) . '">' . __( 'Widget content',
				'micwag-last-posts-widget' ) . ': </label>';
